...
def _prepare_for_experiment(args):
    ...
    settings = {'num_splits': args.k,
                ...
                'raw_wsi_dir': getattr(args, 'raw_wsi_dir', None),
                'patch_coords_dir': getattr(args, 'patch_coords_dir', None),
                'online_conch_model_dir': getattr(args, 'online_conch_model_dir', None),
                'online_target_patch_size': getattr(args, 'online_target_patch_size', 448),
                'online_patch_batch_size': getattr(args, 'online_patch_batch_size', 8),
                'conch_qv_lora_mode': getattr(args, 'conch_qv_lora_mode', 'gene'),
                'conch_qv_lora_layers': getattr(args, 'conch_qv_lora_layers', 2),
                'conch_qv_lora_rank': getattr(args, 'conch_qv_lora_rank', 8),
                'conch_qv_lora_alpha': getattr(args, 'conch_qv_lora_alpha', None),
                'conch_qv_lora_dropout': getattr(args, 'conch_qv_lora_dropout', 0.0),
                'conch_gene_hidden_dim': getattr(args, 'conch_gene_hidden_dim', 128),
                'conch_gradient_checkpointing': getattr(args, 'conch_gradient_checkpointing', True),
