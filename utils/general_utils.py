...
def _prepare_for_experiment(args):
    ...
    settings = {'num_splits': args.k,
                ...
                'gc_rsm_mode': getattr(args, 'gc_rsm_mode', 'none'),
                'gc_rsm_rank': getattr(args, 'gc_rsm_rank', 16),
                'gc_rsm_hidden_dim': getattr(args, 'gc_rsm_hidden_dim', 128),
                'gc_rsm_dropout': getattr(args, 'gc_rsm_dropout', 0.0),
                'gc_rsm_residual_scale': getattr(args, 'gc_rsm_residual_scale', 1.0),
